...
import '../../logic/pass_exam/pass_exam_cubit.dart';
import '../../logic/time/time_display.dart';

class PassExam extends StatefulWidget {
  static const String id = "PassExam";

  const PassExam({super.key});

  @override
  State<PassExam> createState() => _PassExamState();
}

class _PassExamState extends State<PassExam> {
  var items = ["Uzb", "Rus"];
  String myValue = "Uzb";

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PassExamCubit, PassExamState>(
      builder: (context, state) {
        if (state is PassExamLoading) {
          return Scaffold(
            body: Container(
                            ...
                            SizedBox(
                              ...
                              child: TabBarView(
                                children: List<Widget>.generate(
                                  state.tests.length,
                                  (index) {
                                    return BlocBuilder<PassExamCubit,
                                        PassExamState>(
                                      builder: (context, state) {
                                        Logger().e(state);
                                        if (state is PassExamFailure) {
